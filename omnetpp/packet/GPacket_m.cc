...
long long gPacket::getOffset() const
{
    return offset_var;
}

void gPacket::setOffset(long long offset_var)
{
    this->offset_var = offset_var;
}
...
bool gPacketDescriptor::getFieldAsString(void *object, int field, int i, char *resultbuf, int bufsize) const
{
    ...
    switch (field) {
        ...
        case 8: long2string(pp->getOffset(),resultbuf,bufsize); return true;
        case 9: long2string(pp->getSize(),resultbuf,bufsize); return true;
        case 10: long2string(pp->getRead(),resultbuf,bufsize); return true;
        case 11: long2string(pp->getDecision(),resultbuf,bufsize); return true;
        case 12: long2string(pp->getApp(),resultbuf,bufsize); return true;
...
bool gPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setOffset(string2long(value)); return true;
        case 9: pp->setSize(string2long(value)); return true;
        case 10: pp->setRead(string2long(value)); return true;
        case 11: pp->setDecision(string2long(value)); return true;
        case 12: pp->setApp(string2long(value)); return true;
        default: return false;
    }
}
